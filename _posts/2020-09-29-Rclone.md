...
Otra utilidad es la de montar las unidades del proveedor como unidad local. La información seguira estando en la nube pero podemos trabajar con ella como si estuviera en local:

Para esto hay que tener instalado el paquete "fuse" en la máquina local:
